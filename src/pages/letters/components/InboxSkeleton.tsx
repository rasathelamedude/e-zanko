      ...
      {[...Array(5)].map((_, i) => (
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            />
            <div
              className="h-5 w-14 rounded-full bg-muted animate-pulse"
              style={{ animationDelay: `${i * 80 + 40}ms` }}
            />
          </div>
          <div
            className="h-3.5 rounded bg-muted animate-pulse mb-1.5"
            style={{
...
function LetterDetailsSkeleton() {
  return (
    <div className="border border-border rounded-xl p-6 bg-card h-full">
      ...
      <div className="h-7 w-2/3 rounded bg-muted animate-pulse mb-6" />
      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="h-3.5 rounded bg-muted animate-pulse w-full" />
          <div className="h-3.5 rounded bg-muted animate-pulse w-full" />
