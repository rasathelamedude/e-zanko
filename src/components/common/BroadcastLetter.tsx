...
function BroadcastLetter({ onClose }: ComposeLetterProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div
        ref={popupRef}
        className="w-140 bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100"
      >
        ...
        <div className="flex justify-end items-center gap-2 px-6 py-4 bg-gray-50 border-t border-gray-100">
          <Button
            onClick={onClose}
            variant="outline"
            className="text-sm text-gray-600 border-gray-200 hover:bg-gray-100 hover:text-gray-800 cursor-pointer"
          >
            {t("Cancel")}
          </Button>
