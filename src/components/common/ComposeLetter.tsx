    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      ...
      >
        ...
        <div
          ...
          className="flex items-center gap-2 ms-6 mb-3 px-3 py-2 border border-dashed border-border rounded-lg cursor-pointer hover:border-teal-600 hover:bg-teal-500/10 transition-colors w-fit"
        >
